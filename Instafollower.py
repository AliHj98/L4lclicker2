...
while x  < 100 :
  ...
  time.sleep(6)
  y = pyautogui.locateOnScreen('instafollow.png', confidence = 0.9) #locate first like
  ...
  time.sleep(6)
  z = pyautogui.locateOnScreen('instafollow.png', confidence = 0.9) #locate second like
  if z!=None:
